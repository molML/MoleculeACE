...
def main():
    ...
    descriptors_algorithms = {
        Descriptors.ATTENTIVE_GRAPH: [Algorithms.AFP],
        Descriptors.CANONICAL_GRAPH: [Algorithms.MPNN, Algorithms.GAT, Algorithms.GCN]}
    print("Test load configs for gnn models")
    for descriptor, algorithms in tqdm(descriptors_algorithms.items()):
        ...
        for algorithm in tqdm(algorithms):
            ...
            config_file = os.path.join(CONFIG_PATH, dataset, f"{algorithm.value}_{descriptor.value}.json")
